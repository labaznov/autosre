...
| Вы | Вам сюда | Объём |
| :--- | :--- | :--- |
| Ставите и эксплуатируете | [`docs/OPERATIONS.md`](docs/OPERATIONS.md) — установка, ресурсы, первый день, бэкап, что делать когда | 15 минут |
| Дежурите | [`docs/DUTY.md`](docs/DUTY.md) — что перед вами и что с этим делать | 10 минут |
| Настраиваете мониторинг | [`docs/METRICS.md`](docs/METRICS.md) — все метрики и с чего начать алерты | 5 минут |
| Пишете скиллы и заметки | [`docs/KNOWLEDGE.md`](docs/KNOWLEDGE.md) — форма файлов репозитория знаний | 10 минут |
| Разрабатываете | [`AGENTS.md`](AGENTS.md), дальше по ссылкам оттуда | час |

Остальное — для тех, кто хочет разобраться глубже:

- [`docs/SPEC.md`](docs/SPEC.md) — что строим, словарь терминов, конвейер,
  критерии приёмки
- [`docs/adr/`](docs/adr/README.md) — 28 решений и почему устроено именно так,
  с отвергнутыми вариантами
...
- [`examples/sreagent.toml`](examples/sreagent.toml) — все настройки с
  пояснениями
