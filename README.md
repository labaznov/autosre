...
| [`docs/TASKS.md`](docs/TASKS.md) | 34 задачи с критериями готовности и отметками, где сделано иначе |
...
| [`docs/REVIEW.md`](docs/REVIEW.md) | ревизия сентября 2026: замечания, деплой без интернета, вижен, дорожная карта |
